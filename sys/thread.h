...
//         struct {
//             uint64_t a[8];      // s0 .. s7
//             void (*pc)(void);   // s8: should point to thread exit
//             uint64_t _pad;      // s9
//             void * fp;          // s10 the frame pointer points to where the start of the THREAD is located
//             void * ra;          // s11 point to actual entry function
//         } startup;
//     };

//     void * ra;          //  TO GO TO thread_start()
//     void * sp;          //  poitns to where we are in the "thread" memory, i.e. the thread stack
// };
